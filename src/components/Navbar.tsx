...
const Navbar = () => {
  ...
  return (
    <nav
      className={`sticky top-0 z-10 flex lg:px-[120px] lg:py-[25px] py-5 justify-between items-center px-5 bg-white ${
    ...
    >
      ...
      <div className="transition-all duration-150 group hover:border-white hover:bg-[#F2B304]  border border-[#F2B304] p-[9px] lg:p-[12px] rounded-[4px] shadow-[4px_4px_14px_0px_#000000F] cursor-pointer">
        <svg
          width="18"
          height="18"
          viewBox="0 0 18 18"
        ...
        >
          <path
            ...
            className="fill-[#FFBB00] group-hover:fill-[#fff]"
          />
        </svg>
      </div>
    </nav>
